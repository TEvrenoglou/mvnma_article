...
# Fit the model with standard priors for basic parameters
# set.seed(1909)
...
#                         n.thin = 20)
# 
# # Fit the model with DuMouchel priors for basic parameters
...
# Read results directly from the "Results" folder
...
# Define small.values for each outcomes
...
vikos_DM_sucra <- vikor(ranks_DM_sucra)
